# interview-partner
A personal user interview partner that helps note take and prompt you to answer key questions needed for each interview. 

There are 1,000 of user interview note taking apps, but this one is mine; it has just the right amount of structure and flexibility so as not to get in my way during user interview conversations with a loose script, but allowed to go in organic directions that are interesting. I also hope this flow will help me scale up user interviews with engineers in my team, allowing more teammates to do interviews and quickly share data, synthesize findings, and share insights without too many logistics. 
