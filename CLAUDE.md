...
- **Entitlements File**: `Config/InterviewPartner.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/InterviewPartner.entitlements`:
